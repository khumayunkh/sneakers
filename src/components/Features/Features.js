...
import sneakers_3 from './../../img/feature_2.png'
import sneakers_2 from './../../img/feature_3.png'
            ...
            <div className={style.features}>
                ...
                <div className={style.products}>
                    ...
                    <div className={style.product}>
                        ...
                        <img src={stars}/>
                        <h4 className={style.product_title}>Adidas Falcon Shoes for men - 2021 Edition</h4>
                        <h3 className={style.price}>$160.99</h3>
                    </div>
                    <div className={style.product}>
                        <div className={style.sneakers_in}>
                        ...
                        <img src={stars}/>
                        <h4 className={style.product_title}>Adidas Falcon Shoes for men - 2021 Edition</h4>
                        <h3 className={style.price}>$230.50</h3>
                    </div>
                    <div className={style.product}>
                        <div className={style.sneakers_in}>
                        ...
                        <img src={stars}/>
                        <h4 className={style.product_title}>Adidas Falcon Shoes for men - 2021 Edition</h4>
                        <h3 className={style.price}>$420.00</h3>
                    </div>
                </div>
            </div>
        </div>
